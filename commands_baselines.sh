...
time python building_disagg_baseline.py --output_dir ~/data/wpop/preproc2/tza_bdisagg/ --train_dataset_name tza --test_dataset_name tza
...
time python train_model_with_agg_data.py -pre ~/data/wpop/preproc2/tza_preproc_input.pkl -adm_rst ~/data/wpop/OtherMastergrid/TZA/tza_subnational_2000_2020_sid.tif -out ~/data/wpop/predictions/wpop_tza_c_311_rs1610_rsf1610/ -data tza -bu True -e5f True -train_lvl c -rs 1610 -rsf 1610

### WorldPop - trained with fine scale census data, using the split 3/1/1
time python train_model_with_agg_data.py -pre ~/data/wpop/preproc2/tza_preproc_input.pkl -adm_rst ~/data/wpop/OtherMastergrid/TZA/tza_subnational_2000_2020_sid.tif -out ~/data/wpop/predictions/wpop_tza_f_311_rs1610_rsf1610/ -data tza -bu True -e5f True -train_lvl f -rs 1610 -rsf 1610
...
time python train_model_with_agg_data_for_transfer_task.py -pre_dir ~/data/wpop/preproc2/ -out ~/data/wpop/preproc2/train5_f_test_tza/ -train uga,rwa,moz,cod,nga -test tza -bu True -tperc 0.8 -train_lvl f -rs 1610 -rsf 1610 -pop_target True -log True
