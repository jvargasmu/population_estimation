...
def read_multiple_targets_from_zaf_csv(csv_path, id_col, selected_cols, header_row_index = 3):
    data_per_col = {}
    col_to_index = {}
    index_to_col = {}
...
def preprocessing_zaf_census_data(wp_regions_path, rst_wp_regions_path, census_data_path, 
    ...
    id_col = "GEO_MATCH"
    pdata = read_multiple_targets_from_zaf_csv(census_data_path, id_col, selected_cols)
...
def main():
    ...
    parser.add_argument("wp_regions_path", type=str,
                        help="Shapefile with Worldpop.org administrative regions")
    ...
    preprocessing_zaf_census_data(args.wp_regions_path, args.rst_wp_regions_path, args.census_data_path, 
